...
public class HoraActualizadaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //Haciendo que se refresque cada cierto tiempo. En este caso cada segundo
        resp.setHeader("refresh","1");

        LocalTime hora = LocalTime.now(); //Obteniendo hora actual
        DateTimeFormatter df = DateTimeFormatter.ofPattern("hh:mm:ss"); //Especificando un formato
